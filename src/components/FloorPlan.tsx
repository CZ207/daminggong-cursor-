export function FloorPlan() {
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden rounded-lg border border-stone-700/80 bg-stone-900/50 p-4">
      <h3 className="mb-2 text-sm font-bold text-[#b91c1c]">平面布局与柱网</h3>
